(defproject davstore "0.1.0-alpha5"
  ...
  :dependencies [[org.clojure/clojure "1.7.0-alpha5"]
                 ...
                 [webnf/base "0.1.0-alpha10"
                  :exclusions [org.clojure/data.xml]]
                 [webnf/handler "0.1.0-alpha10"]
                 [webnf/datomic "0.1.0-alpha10"]
                 [webnf/enlive.clj "0.1.0-alpha10"]
                 [webnf.deps/universe "0.1.0-alpha10"
                  :exclusions [org.clojure/data.xml]]
